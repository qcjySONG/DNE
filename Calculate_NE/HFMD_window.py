...
# 定义文件夹路径  
folder_path = './HFMD_re/'  # 替换为你的文件夹路径  
names = ["Year 2022-2023 Tokyo", "Year 2021-2022 Tokyo", "Year 2020-2021 Tokyo", "Year 2019-2020 Tokyo", "Year 2018-2019 Tokyo"]  
nums = [-1, -2, -3, -4, -5]  
...
for i in range(len(nums)):  
    ...
    # 保存图形为文件  
    save_path = f'./HFMD_NE//HFMD_{names[i]}.png'  # 保存的文件名和路径  
